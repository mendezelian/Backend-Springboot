...
public class JugadorService{
	...
	// Login para jugador
    public JugadorResponseDto login(JugadorLoginRequestDto jugadorLoginRequestDto){
        Jugador jugador = this.jugadorRepository.findByEmail(jugadorLoginRequestDto.getEmail())
